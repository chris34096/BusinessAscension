...
- In the correct folder? (`08-SECOND-CERVEAU/work/active/` vs `08-SECOND-CERVEAU/work/archive/` vs `08-SECOND-CERVEAU/work/incidents/` etc.)
- Description accurate and ~150 chars?
- Status field correct?

### 3. Check Index Consistency

- `08-SECOND-CERVEAU/work/Index.md` — are new notes linked? Are completed projects in the right section?
- `08-SECOND-CERVEAU/brain/Memories.md` — does Recent Context reflect what happened this session?
- `08-SECOND-CERVEAU/org/People & Context.md` — any new people or relationship changes to capture?
- `08-SECOND-CERVEAU/perf/Brag Doc.md` — any wins or achievements from this session?
- `08-SECOND-CERVEAU/Home.md` — are embedded Bases still valid?
...
- Are there notes in `08-SECOND-CERVEAU/work/active/` that should be moved to `08-SECOND-CERVEAU/work/archive/YYYY/`?
- Any status fields still `active` that should be `completed`?

### 6. Ways of Working Review

Check if this session revealed:
- A new pattern that should be in `08-SECOND-CERVEAU/brain/Patterns.md`?
- A new gotcha that should be in `08-SECOND-CERVEAU/brain/Gotchas.md`?
- A workflow improvement for `08-SECOND-CERVEAU/brain/Skills.md`?
