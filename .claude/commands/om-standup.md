...
1. Read `08-SECOND-CERVEAU/Home.md` for current dashboard state
2. Read `08-SECOND-CERVEAU/brain/North Star.md` for current goals
3. Check `08-SECOND-CERVEAU/work/Index.md` for active projects
...
- **Active Work**: Current projects in 08-SECOND-CERVEAU/work/active/ with their status
