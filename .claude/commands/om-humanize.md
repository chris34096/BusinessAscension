...
- `08-SECOND-CERVEAU/brain/North Star.md` — how you write about yourself
- The most recent `08-SECOND-CERVEAU/work/1-1/*.md` note — natural conversational voice
...
- **`08-SECOND-CERVEAU/work/1-1/`** → conversational, direct, uses "I", okay to be informal
- **`08-SECOND-CERVEAU/perf/` review content** → corporate-confident but human, evidence-based, respect charcount
- **`08-SECOND-CERVEAU/work/incidents/`** → precise, factual, timeline-oriented, no filler
- **`08-SECOND-CERVEAU/brain/`** → terse shorthand, fragments okay
...
- If charcount matters (review content in `08-SECOND-CERVEAU/perf/`), verify limits after editing with `node --experimental-strip-types .claude/scripts/charcount.ts`.
