...
- Read any `08-SECOND-CERVEAU/work/1-1/*.md` notes from this week
- Check `08-SECOND-CERVEAU/work/active/` for status changes
- Check `08-SECOND-CERVEAU/work/incidents/` for new or updated incidents
- Read today's daily note if it exists: `obsidian daily:read`

### 2. North Star Alignment

Read `08-SECOND-CERVEAU/brain/North Star.md` and compare actual activity against stated focus:
...
Additionally check:
- Were completed items logged in `08-SECOND-CERVEAU/perf/Brag Doc.md` or the current quarter's brag note?
...
- "Want me to save this as `08-SECOND-CERVEAU/thinking/weekly-YYYY-MM-DD.md`?"
