...
2. **Create work note** at `08-SECOND-CERVEAU/work/1-1/<Participant> <YYYY-MM-DD>.md` with:
...
4. **Update related notes**:
   ...
   - `08-SECOND-CERVEAU/work/Index.md` (add to Review Prep or Active Projects as appropriate)
   - `08-SECOND-CERVEAU/brain/Memories.md` if any context changed (manager dynamics, priorities, etc.)
   - `08-SECOND-CERVEAU/org/people/` note for the participant
