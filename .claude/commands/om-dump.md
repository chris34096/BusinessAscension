...
3. **Create or update** the appropriate note following CLAUDE.md conventions:
   - Correct folder placement (08-SECOND-CERVEAU/work/active/, 08-SECOND-CERVEAU/work/incidents/, 08-SECOND-CERVEAU/work/1-1/, 08-SECOND-CERVEAU/org/people/, etc.)
...
4. **Update indexes** as needed (08-SECOND-CERVEAU/work/Index.md, 08-SECOND-CERVEAU/perf/Brag Doc.md, 08-SECOND-CERVEAU/org/People & Context.md)
