...
Read in order:
1. `08-SECOND-CERVEAU/brain/North Star.md` — current goals and focus
2. `08-SECOND-CERVEAU/perf/<cycle>/Review Brief.md` — the full private review brief
3. `08-SECOND-CERVEAU/perf/<cycle>/Review Brief - Manager.md` — what the manager has seen
4. Previous cycle review — baselines
5. Quarterly brag notes covering the period
6. All competency notes in `08-SECOND-CERVEAU/perf/competencies/`
7. `08-SECOND-CERVEAU/perf/Performance Framework.md` — evaluation structure (if exists)
...
Save draft to `08-SECOND-CERVEAU/thinking/review-drafts.md` for copy-pasting.
After submission, promote to `08-SECOND-CERVEAU/perf/<cycle>/Self-Review.md`.
