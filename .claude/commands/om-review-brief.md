...
- `08-SECOND-CERVEAU/perf/<cycle>/Review Brief.md` (or current private brief) — full context
- `08-SECOND-CERVEAU/perf/Brag Doc.md` — quarterly highlights
- `08-SECOND-CERVEAU/perf/brag/Q*.md` — quarterly detail notes for the period
- `08-SECOND-CERVEAU/perf/evidence/Your PRs - *.md` — PR data
- `08-SECOND-CERVEAU/work/*.md` — project notes for the period
- `08-SECOND-CERVEAU/perf/competencies/*.md` — competency definitions
...
- Markdown version in `08-SECOND-CERVEAU/perf/`
