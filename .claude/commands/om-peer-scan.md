...
Deep scan a peer's GitHub PRs for performance review preparation. Produces a structured analysis saved to `08-SECOND-CERVEAU/perf/evidence/`.
...
4. **Save to vault** as `08-SECOND-CERVEAU/perf/evidence/<Name> PRs - <Period>.md` with frontmatter:
   ```yaml
   ---
   date: "<today>"
