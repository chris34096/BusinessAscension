...
- Check if they have a person note in `08-SECOND-CERVEAU/org/people/`
...
Create `08-SECOND-CERVEAU/work/incidents/<Incident Name>.md` with:
...
- Create in `08-SECOND-CERVEAU/org/people/` with proper frontmatter (`date`, `title`, `description`, `team`, `tags: [person]`)
- Add to `08-SECOND-CERVEAU/org/People & Context.md`
...
- `08-SECOND-CERVEAU/work/Index.md` — add to Incidents section
- `08-SECOND-CERVEAU/brain/Memories.md` — add incident summary to Recent Context
- `08-SECOND-CERVEAU/brain/Patterns.md` — if this reveals a recurring pattern
- `08-SECOND-CERVEAU/brain/Gotchas.md` — if this reveals a technical gotcha
- `08-SECOND-CERVEAU/perf/Brag Doc.md` — add to relevant quarter with competency links
- `08-SECOND-CERVEAU/perf/brag/QN YYYY.md` — add detailed brag entry
...
- Create `08-SECOND-CERVEAU/work/incidents/TICKET-XXXX Post-Mortem Draft.md` following your org's post-mortem template
