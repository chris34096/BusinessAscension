...
Load in order:
1. Person note from `08-SECOND-CERVEAU/org/people/<Name>.md`
2. PR evidence from `08-SECOND-CERVEAU/perf/evidence/<Name> PRs - <cycle>.md` (run `/om-peer-scan` if missing)
3. Peer review notes from `08-SECOND-CERVEAU/work/active/` (any active review writing notes)
...
Save draft to `08-SECOND-CERVEAU/thinking/<name>-peer-review.md` for copy-pasting.
After submission, promote to `08-SECOND-CERVEAU/perf/<cycle>/Peer Review - <Full Name>.md`.
