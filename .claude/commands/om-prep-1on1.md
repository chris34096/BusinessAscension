...
1. **Load person context** — read `08-SECOND-CERVEAU/org/people/$ARGUMENTS.md` for role, relationship, key moments, and any standing dynamics

2. **Load recent 1:1 history** — check `08-SECOND-CERVEAU/work/1-1/` for prior notes with this person; surface:
   - Unresolved action items from last meeting
   - Topics that recurred across sessions
   - Anything flagged in "What to Watch"

3. **Load active work** — read `08-SECOND-CERVEAU/work/Index.md` and relevant `08-SECOND-CERVEAU/work/active/*.md` notes; identify:
...
4. **Check North Star alignment** — read `08-SECOND-CERVEAU/brain/North Star.md`; flag:
   - Goals drifting or with no active work
   - Emerging focus that hasn't been written down yet

5. **Surface wins to share** — check `08-SECOND-CERVEAU/perf/Brag Doc.md` and the current quarter's brag note for completed work or milestones since the last 1:1 with this person
...
Run `/om-capture-1on1 $ARGUMENTS` to file the notes into `08-SECOND-CERVEAU/work/1-1/` and update the person note.
