...
For each person:
- Check if `08-SECOND-CERVEAU/org/people/<Real Name>.md` exists.
...
For each person without a vault note, create `08-SECOND-CERVEAU/org/people/<Real Name>.md`:
...
Read `08-SECOND-CERVEAU/org/People & Context.md`. For each new person:
- Add a one-line entry in the `## People` section.
- Format: `- [[Person Name]] — Title. Brief context.`

### 6. Check Team Notes

If a person's team is identifiable and the team doesn't have a note in `08-SECOND-CERVEAU/org/teams/`:
