...
- Flag people who don't have person notes in `08-SECOND-CERVEAU/org/people/`.
...
Write the reconstruction to `08-SECOND-CERVEAU/thinking/slack-archaeology-YYYY-MM-DD.md` with:
