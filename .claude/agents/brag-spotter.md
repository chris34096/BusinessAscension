...
From today's date, determine the current quarter (Q1-Q4) and year. Find or note the corresponding brag file: `08-SECOND-CERVEAU/perf/brag/QN YYYY.md`.

### 2. Read Current Brag State

Read `08-SECOND-CERVEAU/perf/Brag Doc.md` and the current quarter's brag note. Build a list of what's ALREADY captured.

### 3. Scan for Uncaptured Wins

Check these sources for achievements not yet in the brag doc:

**Work notes (08-SECOND-CERVEAU/work/active/ and 08-SECOND-CERVEAU/work/archive/):**
...
**Brain notes:**
- `08-SECOND-CERVEAU/brain/Patterns.md` — new patterns discovered (shows expertise growth)
- `08-SECOND-CERVEAU/brain/Key Decisions.md` — decisions led (shows leadership)

### 4. Check Competency Coverage

For each competency in `08-SECOND-CERVEAU/perf/competencies/`:
