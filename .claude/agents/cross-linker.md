...
- `08-SECOND-CERVEAU/org/people/*.md` — every person name (including aliases from frontmatter)
- `08-SECOND-CERVEAU/org/teams/*.md` — every team name
- `08-SECOND-CERVEAU/perf/competencies/*.md` — every competency name
- `08-SECOND-CERVEAU/work/active/*.md`, `08-SECOND-CERVEAU/work/archive/**/*.md` — every project name
- `08-SECOND-CERVEAU/work/incidents/*.md` — every incident name
...
Write findings to `08-SECOND-CERVEAU/thinking/cross-link-audit-YYYY-MM-DD.md` with:
