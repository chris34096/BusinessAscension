...
- Person → `08-SECOND-CERVEAU/org/people/<Name>.md`
- Project → `08-SECOND-CERVEAU/work/active/<Name>.md` or `08-SECOND-CERVEAU/work/archive/**/<Name>.md`
- Incident → `08-SECOND-CERVEAU/work/incidents/<Name>.md`
- Team → `08-SECOND-CERVEAU/org/teams/<Name>.md`
- Concept → search `08-SECOND-CERVEAU/brain/`, `reference/`
...
- `08-SECOND-CERVEAU/work/` — project context, incident timelines
- `08-SECOND-CERVEAU/work/1-1/` — meeting discussions about this topic
- `08-SECOND-CERVEAU/perf/` — brag entries, evidence, review briefs
- `08-SECOND-CERVEAU/brain/` — memories, patterns, decisions, gotchas
